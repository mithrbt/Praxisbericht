...
\usepackage{listings}
\usepackage{xcolor} % Falls du Farben verwenden möchtest
% Definiere die Sprache JavaScript
\lstdefinelanguage{JavaScript}{
    keywords={async, await, try, catch, const, let, if, else, return, throw, Promise},
